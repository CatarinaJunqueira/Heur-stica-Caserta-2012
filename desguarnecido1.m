% Nome: Desquarnecido1
% Objetivo: localiza posicoes vazias nas quais um conteiner que precisa ser
% remanejado pode ser colocado. Localiza apenas as posicoes que sao topo ou
% chao.

%----------------------------------------%
% localiza posições vazias que são topo ou      7 8 9
% chão para a regra Rt1:                        4 5 6
%                                               1 2 3
%----------------------------------------%

function [vazio] = desguarnecido1(patio,posicao_navio) % localiza posição e não conteúdo.
